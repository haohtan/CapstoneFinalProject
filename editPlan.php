...
if(isset($_POST['submit'])){
    ...
    $sql = "update `plan` set `day_content`='$dayContent',`plan_title` = '$title',`start_date` = '$startDate',`end_date`='$endDate',`destination`='$destination' where planID = $planID";
...
<html lang="en">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB-qhXvdtD2w5dxG_CD8yp_OX_B06MYHGA&callback=initMap"></script>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" value="<?php echo $resForPlan[0]['plan_title']?>" class="form-style" placeholder="Plan Title" required>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="startDate" value="<?php echo $resForPlan[0]['start_date']?>" id="startDate" class="form-style" placeholder="Start Date" required>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="">End Date</label>
                        <input type="date" name="endDate" id="endDate" value="<?php echo $resForPlan[0]['end_date']?>" class="form-style" placeholder="End Date" required>
                    </div>
                </div>
                <div class="form-group">
